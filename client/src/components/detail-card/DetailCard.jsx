    ...
    return (
        <div className={styles.detailRow}>
            ...
            <div className={styles.columnLeft}>
                <h1>Thinking about visiting <span id={styles.country}>{props.detail.name}</span>?</h1>
            ...
            <div className={styles.columnRight}>
                ...
                <p><strong>{props.detail.name}</strong> ({props.detail.id}) is a country located at <strong>{props.detail.subregion}</strong> which has around <strong>{props.detail.population} citizens</strong> distributed in its <strong>{props.detail.area} km2</strong>.
                <br></br>
                <br></br>
